          ...
          <tr>
            <td align="center" valign="top">
              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
               ...
               <?php   echo   "<p>Hi '.$_SESSION[daftarN].'</p>"?>
                ...
                <tr>
                     <td style="padding-left: 35%;">
                         <a type="button" href="<?php echo base_url().'index.php/confirmation/emailconf/'.$_SESSION["id"].'/'.$_SESSION["kode"];?>" style="width:150px;height:36px;background-color: #d4d4d4;border: none;display:block;padding-top:11px;text-align:center;"> confirmation </a>
                     </td>
                </tr>
                <tr align="top">
